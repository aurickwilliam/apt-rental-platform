# Graph Report - apt-rental-platform  (2026-08-28)

## Corpus Check
- 749 files · ~925,467 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3619 nodes · 7450 edges · 302 communities (188 shown, 114 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0a9375c4`
...
## Communities (302 total, 114 thin omitted)
...
Cohesion: 0.10
Nodes (20): EditSpecs(), DEFAULT_FILTERS, FilterBottomSheet(), FilterState, Props, ROOM_OPTS, SearchFiltersBar(), SearchFiltersBarProps (+12 more)
...
Cohesion: 0.16
Nodes (13): usePayments(), CreateCashPaymentParams, fetchPaymentById(), fetchPaymentByReferenceId(), fetchPayments(), METHOD_LABELS, PaymentRecord, PaymentRow (+5 more)
...
Cohesion: 0.12
Nodes (14): ChannelEntry, SubmitReviewParams, SubmitReviewResult, storage, supabase, CompositeTypes, Constants, DatabaseWithoutInternals (+6 more)

### Community 17 - "auth-complete-profile.tsx"
Cohesion: 0.18
Nodes (19): AuthCompleteProfile(), ProfileForm, requiredFields, CompleteProfile(), ProfileForm, requiredFields, VerifyMobile(), DateField() (+11 more)

### Community 18 - "ScreenWrapper.tsx"
Cohesion: 0.07
Nodes (23): RateApartmentSkeleton(), Index(), Failed(), DOCUMENT_TYPE_ICONS, SelectDocument(), AnalyticsScreen(), MAX_AMOUNT, monthlyData (+15 more)
...
Cohesion: 0.09
Nodes (18): ChatHeader(), ChatHeaderProps, EWalletRedirect(), Add(), PAYMENT_METHOD_TYPES, PaymentMethodType, getLogoSource(), maskMobileNumber() (+10 more)
...
Cohesion: 0.10
Nodes (22): MaintenanceRequests(), Index(), TenantApplications(), EmptyApproved(), Period, Props, RescheduleSheet(), tomorrow (+14 more)
...
Cohesion: 0.10
Nodes (18): Amenities(), AmenitiesProps, ExpandableDescription(), Props, ImageHeader(), ImageHeaderProps, LeaseAgreementCard(), LeaseAgreementCardProps (+10 more)
...
Cohesion: 0.10
Nodes (16): AISearchScreen(), SUGGESTION_CHIPS, EmptyChatState(), MessageBubbleProps, MessageComposer(), MessageComposerProps, ScrollToBottomButton(), ScrollToBottomButtonProps (+8 more)
...
Cohesion: 0.13
Nodes (15): BATHROOM_OPTIONS, BEDROOM_OPTIONS, Filters, INITIAL_FILTERS, LOCATIONS, Props, SORT_OPTIONS, AmenitiesSelect() (+7 more)
...
### Community 50 - "NotificationToast.tsx"
Cohesion: 0.19
Nodes (17): NotificationCard(), NotificationCardProps, NotificationCardType, NotificationFilter, NotificationListProps, NotificationSettingsScreen(), NotificationToastContent(), NotificationToastContentProps (+9 more)

### Community 51 - "utils/src/index.ts"
Cohesion: 0.09
Nodes (26): ApartmentSummary(), MoveInCostFooterProps, MoveInCostFooterSection(), MaintenanceRequestCard(), MaintenanceRequestCardProps, PropertyActionMenu(), Props, ApartmentImage (+18 more)
...
Cohesion: 0.22
Nodes (11): NotificationManager(), RootLayout(), ThemeInitializer(), Index(), DevBadge(), useInAppNotificationBanner(), useNotificationTapHandler(), useTheme() (+3 more)
...
Cohesion: 0.26
Nodes (12): attachPaymentChannel(), attachSubscriber(), attachTenantChannel(), Channel, createRefSubscriber(), detachSubscriber(), getRecordString(), paymentChannels (+4 more)
...
Cohesion: 0.13
Nodes (24): ApartmentsList(), ApartmentsListProps, TenantFavorites(), ApartmentCard(), ApartmentCardProps, getErrorMessage(), getFavoriteApartmentsQueryKey(), getFavoritesQueryKey() (+16 more)
...
Cohesion: 0.15
Nodes (17): TODO: Persist the uploaded document to Supabase Storage and store its, Upload(), ApartmentMainFields, deleteStorageImage(), ExistingImage, PendingImage, thumbPathFor(), UpdateApartmentMainParams (+9 more)

### Community 75 - "edit-main.tsx"
Cohesion: 0.16
Nodes (11): FormErrors, ApartmentInformation, DisplayImage, EditMain(), validateForm(), EditPerks(), updateApartmentMain(), Divider() (+3 more)

### Community 76 - "card-form.tsx"
Cohesion: 0.28
...
### Community 78 - "(auth)/otp-verification.tsx"
Cohesion: 0.32
Nodes (5): OTPVerification(), OTPVerification(), useCountdown(), UseCountdownOptions, getProfileSubmitError()
...
### Community 81 - "useColors"
Cohesion: 0.05
Nodes (56): ReviewDocumentFile(), ReviewDocumentFileProps, ReviewDocumentImage(), ReviewDocumentImageProps, IconButton(), IconButtonProps, IconComponent, RatingBarCount() (+48 more)
...
Cohesion: 0.10
Nodes (24): EMPTY_COUNTS, getLandlordBadgesQueryKey(), ActionBadgeCategory, ActionBadgeCounts, DB_TO_DISPLAY_STATUS, DbStatus, DISPLAY_TO_DB_STATUS, fetchLandlordApartmentIds() (+16 more)
...
Cohesion: 0.20
Nodes (12): useCancelApplication(), getTenantApplicationsQueryKey(), useTenantApplications(), ApplicationDocument, ApplicationDocumentPathKey, ApplicationRow, DOCUMENT_DEFINITIONS, fetchTenantApplications() (+4 more)
...
### Community 101 - "constants/src/index.ts"
Cohesion: 0.16
...
### Community 108 - "edit-profile.tsx"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (20): ErrorDialogState, FormErrors, RateApartment(), TenancyLeasePeriod, AuthButton(), AuthButtonProps, AuthDivider(), AuthDividerProps (+12 more)
...
Cohesion: 0.14
Nodes (15): SORT_OPTIONS, TODO: Implement function to handle report landlord, TODO: Implement function to handle report tenant, DropdownButton(), DropdownButtonProps, PastApartmentCard(), PastApartmentCardProps, ProfileStat (+7 more)

### Community 130 - "Apple Logo"
Cohesion: 1.00
Nodes (3): Apple Logo, Facebook Logo, Google Logo

### Community 133 - "useNotificationRealtime.ts"
Cohesion: 0.21
Nodes (11): MOCK_TOASTS, MockRow, MockToast, NotificationToastDevScreen(), showNotificationToast(), attach(), detach(), handleEvent() (+3 more)

### Community 136 - "tenant-applications/[applicationId].tsx"
Cohesion: 0.25
Nodes (7): EmptyApplicationData(), DocumentRow(), DocumentRowProps, getExtension(), IMAGE_EXTENSIONS, RejectDialog(), RejectDialogProps
...
### Community 150 - "history/index.tsx"
Cohesion: 0.22
Nodes (17): PaymentHistoryCard(), PaymentHistoryCardProps, FlatPayment, PaymentHistoryScreen(), toFlatPayment(), EMPTY_FILTERS, FlatPayment, History() (+9 more)
...
### Community 160 - "createMobileQueryClient"
Cohesion: 0.16
...
Cohesion: 0.12
Nodes (8): PaymentHistoryFilters, PaymentSort, Props, SORT_OPTIONS, APARTMENT_FLOOR_AREA, APARTMENT_ROOM_LIMITS, DOCUMENT_TYPES, PAYMENT_STATUS
...
### Community 181 - "first-process.tsx"
Cohesion: 0.38
...
Cohesion: 0.07
Nodes (32): ReviewAccordionItem(), ReviewAccordionItemProps, FormErrors, Amenities(), FourthStep(), FormErrors, Index(), DEFAULT_COORDS (+24 more)
...
Cohesion: 0.08
Nodes (32): ApartmentSkeleton(), ApartmentDescriptionSection(), ApartmentDescriptionSectionProps, ApartmentDetailsSection(), ApartmentDetailsSectionProps, ApartmentHeroSection(), ApartmentHeroSectionProps, ApartmentImage (+24 more)
...
Cohesion: 0.20
Nodes (14): NotificationList(), NotificationScreen(), NotificationScreenProps, useNotificationActions(), useNotificationRealtime(), getErrorMessage(), getNotificationsQueryKey(), getUnreadNotificationsQueryKey() (+6 more)

### Community 248 - "ApplicationStatusCard.tsx"
Cohesion: 0.31
...
### Community 250 - "hooks/src/index.ts"
Cohesion: 0.39
Nodes (4): ResetPassword(), AppInput(), AppInputProps, usePasswordValidation()

### Community 253 - "useLandlordMaintenanceRequests.ts"
Cohesion: 0.43
...
### Community 257 - "src/middleware.ts"
Cohesion: 0.36
...
Cohesion: 0.11
Nodes (22): getLastMessageDisplay(), MessageCard(), MessageCardProps, Chat(), Chat(), EMPTY_STATE_IMAGES, BroadcastEvent, BroadcastPayload (+14 more)
...
### Community 274 - "paymongoService.ts"
Cohesion: 0.18
...
### Community 286 - "useProfile"
Cohesion: 0.07
Nodes (35): FifthStep(), EmptyRequestData(), VisitRequestCardProps, VisitRequestDetails(), MessageBubble(), Profile(), ApplicationApartment(), Props (+27 more)

### Community 290 - "useTenancyRealtime.test.ts"
Cohesion: 0.18
...
### Community 293 - "fifth-step.tsx"
Cohesion: 0.14
Nodes (13): PerksSectionProps, DEFAULT_COORDS, DirectionMode, MAP_STYLE, DEFAULT_COORDS, MAP_STYLE, CurrentApartmentDetails(), formatDateToMonthYear() (+5 more)

### Community 294 - "payments/index.ts"
Cohesion: 0.22
...
### Community 300 - "useLandlordUnits.ts"
Cohesion: 0.47
...
### Community 305 - "request-visit.tsx"
Cohesion: 0.22
Nodes (7): Props, QuantityField(), HOURS, Period, PERIODS, Props, TimeField()

### Community 307 - "tenancy/index.ts"
Cohesion: 0.39
...
## Knowledge Gaps
- **1318 isolated node(s):** `1. System Overview`, `2. Repository Structure`, `3. High-Level Architecture`, `4.1 Stack`, `4.2 Identity model` (+1313 more)
...
- **Why does `useColors()` connect `useColors` to `units.tsx`, `[landlordId].tsx`, `useSearchLogic.tsx`, `profilesService.ts`, `payment/index.tsx`, `request-maintenance.tsx`, `tenant-applications/[applicationId].tsx`, `useVerificationStore`, `useChatChannel.ts`, `live-capture.tsx`, `auth-complete-profile.tsx`, `ScreenWrapper.tsx`, `history/index.tsx`, `step-five.tsx`, `images.ts`, `formatDate`, `useProfile`, `notifications/index.ts`, `ChatBubble.tsx`, `fifth-step.tsx`, `payments/index.ts`, `ai-search.tsx`, `tenant-applications/index.tsx`, `NotificationToast.tsx`, `utils/src/index.ts`, `ProfitTrendCard.tsx`, `app/_layout.tsx`, `document-id/index.tsx`, `upload-id.tsx`, `second-step.tsx`, `useFavorites`, `updateApartmentMain.ts`, `edit-main.tsx`, `(auth)/otp-verification.tsx`, `PaymentMethodSelector.tsx`, `useApplicationActions.test.tsx`, `apartments/index.ts`, `TabBar.tsx`, `[conversationId].tsx`, `edit-profile.tsx`, `pending.tsx`, `captureSequences.ts`, `ApplicationStatusCard.tsx`, `rate-apartment.tsx`, `hooks/src/index.ts`, `maintenance-requests/index.tsx`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `expo-router` connect `expo-router` to `units.tsx`, `[landlordId].tsx`, `useSearchLogic.tsx`, `expo`, `payment/index.tsx`, `request-maintenance.tsx`, `tenant-applications/[applicationId].tsx`, `useVerificationStore`, `useChatChannel.ts`, `live-capture.tsx`, `supabase/src/index.ts`, `auth-complete-profile.tsx`, `ScreenWrapper.tsx`, `history/index.tsx`, `step-five.tsx`, `images.ts`, `formatDate`, `useProfile`, `fifth-step.tsx`, `payments/index.ts`, `tenant-applications/index.tsx`, `NotificationToast.tsx`, `utils/src/index.ts`, `request-visit.tsx`, `first-process.tsx`, `app/_layout.tsx`, `document-id/index.tsx`, `useFrameQualityCheck.ts`, `upload-id.tsx`, `second-step.tsx`, `useFavorites`, `useInAppNotificationBanner.tsx`, `updateApartmentMain.ts`, `edit-main.tsx`, `card-form.tsx`, `(auth)/otp-verification.tsx`, `onboarding.tsx`, `useColors`, `apartments/index.ts`, `[conversationId].tsx`, `constants/src/index.ts`, `pending.tsx`, `captureSequences.ts`, `ApplicationStatusCard.tsx`, `rate-apartment.tsx`, `hooks/src/index.ts`, `maintenance-requests/index.tsx`?**
