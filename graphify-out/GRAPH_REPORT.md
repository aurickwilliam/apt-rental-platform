# Graph Report - apt-rental-platform  (2026-09-09)

## Corpus Check
- 794 files · ~950,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3776 nodes · 7832 edges · 329 communities (212 shown, 117 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 57 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `544f952a`
...
1. `useColors()` - 337 edges
2. `ScreenWrapper` - 101 edges
3. `cn()` - 79 edges
4. `formatPesoDisplay()` - 63 edges
5. `supabase` - 62 edges
6. `StandardHeader()` - 53 edges
7. `useCurrentUser()` - 52 edges
8. `formatDate()` - 52 edges
9. `useProfile()` - 42 edges
10. `createClient()` - 41 edges
...
## Communities (329 total, 117 thin omitted)

### Community 0 - "ScreenWrapper.tsx"
Cohesion: 0.07
Nodes (30): RateApartmentSkeleton(), ErrorDialogState, FormErrors, TenancyLeasePeriod, DOCUMENT_TYPE_ICONS, AnalyticsScreen(), MAX_AMOUNT, monthlyData (+22 more)

### Community 1 - "request-maintenance.tsx"
Cohesion: 0.17
Nodes (20): ResolveRequestDialog(), ResolveRequestDialogProps, MaintenanceRequestDetails(), MaintenanceRequestCard(), MaintenanceRequestCardProps, MaintenanceDetails(), MaintenanceDetails, MaintenanceErrors (+12 more)
...
Cohesion: 0.11
Nodes (18): MoveInCostFooterProps, MoveInCostFooterSection(), FieldErrors, ThirdStep(), RentDueCard(), RentDueCardProps, ApartmentDescriptionCard(), ApartmentDescriptionCardProps (+10 more)

### Community 4 - "createClient"
Cohesion: 0.09
Nodes (24): checkEmailAvailability(), CheckEmailAvailabilityResult, calculateAgeFromBirthDate(), completeProfile(), CompleteProfileState, signIn(), SignInFormState, signOut() (+16 more)

### Community 5 - "[tenantId].tsx"
Cohesion: 0.07
Nodes (44): ApartmentScreen(), RateApartment(), PublicLandlordProfile(), PublicTenantProfile(), TODO: Implement function to handle report tenant, PastApartmentCard(), PastApartmentCardProps, getPublicLandlordProfileQueryKey() (+36 more)

### Community 6 - "[sectionId].tsx"
Cohesion: 0.23
Nodes (13): SectionDetail(), scorePreferences(), SECTION_DEFS, SectionId, transformApartments(), useSearchSections(), UseSearchSectionsParams, hasPersonalization() (+5 more)

### Community 7 - "second-step.tsx"
Cohesion: 0.10
Nodes (14): DEFAULT_COORDS, DEFAULT_ROOM_LIMITS, formatLimitMessage(), formatRange(), FormErrors, isZeroRange(), SecondStep(), APARTMENT_FLOOR_AREA (+6 more)

### Community 8 - "rentals.tsx"
Cohesion: 0.22
Nodes (9): PaymentSummaryCard(), PaymentSummaryCardProps, RentalsSkeleton(), actions, actionsTypes, Rentals(), paidAmountForPeriod(), resolvePaymentPeriod() (+1 more)
...
Cohesion: 0.15
Nodes (13): ApplicationFilters, ApplicationFilterSheet(), LOCATION_OPTIONS, Props, STATUS_OPTIONS, getInitials(), STATUS_STYLES, TenantApplicationCard() (+5 more)
...
### Community 18 - "visit-requests/index.tsx"
Cohesion: 0.14
Nodes (17): VisitRequestCard(), VisitRequestCardProps, getGroup(), Group, GROUP_ORDER, GroupedItem, PastToggle(), VisitRequests() (+9 more)
...
Cohesion: 0.17
Nodes (14): VisitRequestCalendar(), VisitRequestCalendarProps, VisitRequestDetails(), ApplicationApartment(), Props, VisitRequest, VisitRequestCard(), Props (+6 more)
...
Cohesion: 0.06
Nodes (51): IconButton(), IconButtonProps, IconComponent, DirectionMode, MapPreviewSection(), MapPreviewSectionProps, ApartmentMapViewScreen(), DirectionMode (+43 more)
...
Cohesion: 0.13
Nodes (22): Chat(), Chat(), getConversationsQueryKey(), NewChatRow, createWrapper(), mockChannelFn, mockFetchConversations, mockGetChannels (+14 more)
...
### Community 47 - "supabase/src/index.ts"
Cohesion: 0.09
Nodes (26): ApartmentInformation, DisplayImage, EditMain(), validateForm(), EditPerks(), Index(), ApartmentMainFields, deleteStorageImage() (+18 more)
...
### Community 49 - "cards/ApartmentCard.tsx"
Cohesion: 0.21
Nodes (11): ApartmentsList(), ApartmentsListProps, Props, SearchGridSkeleton(), SearchSection(), SearchSectionSkeleton(), Props, SearchSectionsList() (+3 more)

### Community 50 - "maintenance-requests/index.tsx"
Cohesion: 0.18
Nodes (11): MaintenanceRequestCard(), MaintenanceRequestCardProps, MaintenanceRequestCardSkeleton(), LOCATION_OPTIONS, MaintenanceRequestFilters, MaintenanceRequestFilterSheet(), Props, STATUS_OPTIONS (+3 more)
...
### Community 56 - "display/DocumentRow.tsx"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (35): DashboardCard(), DashboardCardProps, formatShortDate(), MiniCalendar(), MiniCalendarProps, toCalendarDate(), PaymentModal(), PaymentModalProps (+27 more)
...
Cohesion: 0.11
Nodes (19): dependencies, expo-crypto, @expo/metro-config, @miblanchard/react-native-slider, react-native-calendars, @react-native-community/slider, react-native-safe-area-context, @react-navigation/bottom-tabs (+11 more)

### Community 71 - "tenant/applications/[applicationId]/page.tsx"
Cohesion: 0.07
...
### Community 76 - "images.ts"
Cohesion: 0.07
Nodes (27): AuthButton(), AuthButtonProps, AuthDivider(), AuthDividerProps, RoleTab(), RoleTabProps, SignIn(), SignUp() (+19 more)

### Community 77 - "PaymentMethodSelector.tsx"
Cohesion: 0.15
...
Cohesion: 0.21
Nodes (15): CardInformation, CardPaymentForm(), CardPaymentFormProps, PaymentMethodSelectorProps, CardForm(), INITIAL_CARD, DateFormat, NameInput (+7 more)
...
### Community 81 - "useLandlordUnits.ts"
Cohesion: 0.38
...
### Community 83 - "conversationService.test.ts"
Cohesion: 0.33
Nodes (6): Conversation, createQuery(), mockFrom, mockLegacyQueries(), mockRpc, seedV2Conversations

### Community 84 - "landlordService.ts"
Cohesion: 0.09
Nodes (27): MaintenanceRequests(), Index(), EMPTY_COUNTS, getLandlordBadgesQueryKey(), useLandlordActionBadges(), useLandlordTenancy(), ActionBadgeCategory, ActionBadgeCounts (+19 more)

### Community 85 - "useTenancy"
Cohesion: 0.27
...
### Community 86 - "useFrameQualityCheck.ts"
Cohesion: 0.18
...
### Community 96 - "NotificationToast.tsx"
Cohesion: 0.16
...
### Community 99 - "upload.tsx"
Cohesion: 0.18
Nodes (12): TODO: Persist the uploaded document to Supabase Storage and store its, Upload(), FormErrors, Index(), ACCEPTED_FILE_TYPES, UploadDocumentField(), UploadDocumentFieldProps, UploadedDocument (+4 more)
...
### Community 105 - "maintenanceService.ts"
Cohesion: 0.19
Nodes (14): MaintenanceHistory(), StatusStyle, getMaintenanceRequestHistoryQueryKey(), useMaintenanceRequestHistory(), UseMaintenanceRequestHistoryParams, getLatestMaintenanceRequestQueryKey(), useMaintenanceRequests(), UseMaintenanceRequestsParams (+6 more)
...
### Community 108 - "first-process.tsx"
Cohesion: 0.22
...
### Community 111 - "payment-history/index.tsx"
Cohesion: 0.27
...
### Community 129 - "notifications/index.ts"
Cohesion: 0.24
Nodes (17): NotificationBellButton(), NotificationBellButtonProps, useNotificationActions(), useNotificationRealtime(), getErrorMessage(), getNotificationsQueryKey(), getUnreadNotificationsQueryKey(), useNotifications() (+9 more)

### Community 130 - "Apple Logo"
Cohesion: 1.00
Nodes (3): Apple Logo, Facebook Logo, Google Logo

### Community 133 - "apartments/index.ts"
Cohesion: 0.26
Nodes (12): ApartmentSummary(), IncludedPerks(), getApartmentDetailsQueryKey(), getApartmentReviewsPreviewQueryKey(), useApartmentDetails(), UseApartmentDetailsOptions, ApartmentDetails, fetchApartmentDetails() (+4 more)
...
### Community 137 - "payment/index.tsx"
Cohesion: 0.13
Nodes (19): validateCashPayment(), formatLeaseDate(), INITIAL_CARD, PaymentCheckout(), toIsoDate(), PaymentVerify(), createCashPayment(), createCardPayment() (+11 more)

### Community 147 - "usePHPostalCode.ts"
Cohesion: 0.10
...
### Community 150 - "rate-apartment/page.tsx"
Cohesion: 0.21
...
Cohesion: 0.18
Nodes (13): getLandlordPaymentsQueryKey(), useLandlordPaymentConfirmation(), useLandlordPayments(), useLandlordStats(), getLandlordTenancyQueryKey(), fetchLandlordPayments(), fetchLandlordStats(), LandlordPaymentRecord (+5 more)
...
Cohesion: 0.16
Nodes (12): BEDROOM_OPTIONS, FAMILY_OPTIONS, NO_PARKING_OPTIONS, RentalPreferences(), DEFAULT_PREFS, prefsEqual(), useRentalPreferencesForm(), parsePreferences() (+4 more)

### Community 161 - "search.tsx"
Cohesion: 0.18
Nodes (12): DEFAULT_FILTERS, FilterBottomSheet(), FilterState, Props, ROOM_OPTS, CITIES, mockFrom, mockIsFavorite (+4 more)

### Community 164 - "RenderApartments.tsx"
Cohesion: 0.16
...
### Community 170 - "useDocumentUrls.ts"
Cohesion: 0.33
Nodes (4): DocEntry, ResolvedDoc, DocumentEntriesProps, mockResolvePrivateMediaUrls

### Community 172 - "useProfile"
Cohesion: 0.17
Nodes (12): TabsLayout(), RequestVisit(), Props, QuantityField(), useProfile(), useSubmitVisitRequest(), VisitRequestPayload, getVisitRequestQueryKey() (+4 more)

### Community 173 - "useInAppNotificationBanner.tsx"
Cohesion: 0.29
...
### Community 177 - "manage-apartment/[apartmentId]/index.tsx"
Cohesion: 0.23
Nodes (7): MaintenanceRequestCard(), MaintenanceRequestCardProps, PropertyActionMenu(), Props, PropertyOverviewSkeleton(), ConfirmDialog(), Props
...
### Community 181 - "fifth-step.tsx"
Cohesion: 0.10
Nodes (24): PerksSection(), PerksSectionProps, Amenities(), DEFAULT_COORDS, FifthStep(), MAP_STYLE, FourthStep(), BasePerkButtonProps (+16 more)
...
### Community 192 - "ProfitByPropertyCard.tsx"
Cohesion: 0.19
Nodes (11): chartLabel(), ProfitByPropertyCard(), ProfitByPropertyCardProps, SearchHeader(), SearchHeaderProps, DropdownButton(), DropdownButtonProps, formatMultiDisplay() (+3 more)

### Community 193 - "ApplicationList.tsx"
Cohesion: 0.19
Nodes (9): ApplicationsList(), ApplicationStatusCard(), Props, ApplicationStatusCardSkeleton(), ApplicationStatus, ApplicationStatusStyle, ChipColor, FALLBACK_STYLE() (+1 more)

### Community 195 - "history/index.tsx"
Cohesion: 0.11
...
### Community 197 - "ApartmentReviewsPreview.tsx"
Cohesion: 0.24
...
### Community 203 - "useNotificationPreferences"
Cohesion: 0.20
Nodes (11): getNotificationPreferencesQueryKey(), createWrapper(), mockFetchNotificationPreferences, mockUpdateNotificationPreferences, mockUseCurrentUser, useNotificationPreferences(), usePushRegistration(), deletePushToken() (+3 more)
...
### Community 217 - "ApartmentImagesModal.tsx"
Cohesion: 0.50
...
### Community 222 - "tenantApplicationsService.ts"
Cohesion: 0.20
...
### Community 223 - "captureSequences.ts"
Cohesion: 0.22
...
### Community 248 - "usePHMobileValidation.ts"
Cohesion: 0.18
...
### Community 250 - "MapLocation.tsx"
Cohesion: 0.33
Nodes (6): LeafletContainer, makeLeafletIcon(), MapLocation(), MapLocationProps, MODES, TransportMode

### Community 253 - "notifications.tsx"
Cohesion: 0.17
Nodes (16): NotificationCard(), NotificationCardProps, NotificationCardType, GENERAL_TOGGLES, GeneralToggleKey, NotificationSettingsScreen(), NotificationToastContent(), NOTIFICATION_TYPE_LABELS (+8 more)

### Community 257 - "RescheduleSheet.tsx"
Cohesion: 0.18
Nodes (10): Period, Props, RescheduleSheet(), tomorrow, toSupabaseTime(), HOURS, Period, PERIODS (+2 more)

### Community 260 - "upload-id.tsx"
Cohesion: 0.32
...
### Community 270 - "useColors"
Cohesion: 0.05
Nodes (53): ReviewDocumentImage(), ReviewDocumentImageProps, RatingBarCount(), RatingBarCountProps, RatingsPage(), Index(), Failed(), SelectDocument() (+45 more)
...
### Community 282 - "live-capture.test.tsx"
Cohesion: 0.25
...
### Community 283 - "getInitials"
Cohesion: 0.32
Nodes (5): ChatEmptyState(), ChatEmptyStateProps, TenantCard(), TenantCardProps, getInitials()

### Community 285 - "useLandlordMaintenanceRequests.ts"
Cohesion: 0.43
...
### Community 286 - "formatAddress"
Cohesion: 0.33
Nodes (5): ApartmentImage, PropertyOverview(), Props, AddressInput, formatAddress()

### Community 287 - "components/ApplicationHeader.tsx"
Cohesion: 0.40
Nodes (4): ApplicationHeader(), ApplicationHeaderProps, CircleProgress(), CircleProgressProps

### Community 290 - "review-information.tsx"
Cohesion: 0.07
Nodes (32): ReviewAccordionItem(), ReviewAccordionItemProps, ReviewDocumentFile(), ReviewDocumentFileProps, ReviewInformation(), FormErrors, SecondProcess(), FormErrors (+24 more)
...
### Community 300 - "constants/src/index.ts"
Cohesion: 0.29
Nodes (6): COLORS, MONTHS, FONT_FAMILIES, THEME_FONTS, THEME_FONTS_WEB, YEARS

## Knowledge Gaps
- **1328 isolated node(s):** `googleMapsKey`, `PaymentSummaryCardProps`, `INITIAL_REGION`, `GoogleMapViewProps`, `UserLocationStatus` (+1323 more)
...
- **Why does `useColors()` connect `useColors` to `ScreenWrapper.tsx`, `request-maintenance.tsx`, `RescheduleSheet.tsx`, `formatPesoDisplay`, `upload-id.tsx`, `apartments/index.ts`, `[tenantId].tsx`, `ChatBubble.tsx`, `second-step.tsx`, `[sectionId].tsx`, `tenant-applications/index.tsx`, `notifications/index.ts`, `rentals.tsx`, `live-capture.tsx`, `payment/index.tsx`, `useFavorites`, `edit-profile.tsx`, `visit-requests/index.tsx`, `applications/index.ts`, `getInitials`, `formatDate`, `formatAddress`, `preferences.tsx`, `search.tsx`, `review-information.tsx`, `app/_layout.tsx`, `map-search.tsx`, `useVerificationStore`, `conversationService.ts`, `ai-search.tsx`, `supabase/src/index.ts`, `manage-apartment/[apartmentId]/index.tsx`, `maintenance-requests/index.tsx`, `ProfitTrendCard.tsx`, `cards/ApartmentCard.tsx`, `fifth-step.tsx`, `display/DocumentRow.tsx`, `document-id/index.tsx`, `pending.tsx`, `ProfitByPropertyCard.tsx`, `ApplicationList.tsx`, `history/index.tsx`, `images.ts`, `PaymentMethodSelector.tsx`, `landlordService.ts`, `useTenancy`, `units.tsx`, `TabBar.tsx`, `[conversationId].tsx`, `NotificationToast.tsx`, `upload.tsx`, `maintenanceService.ts`, `payment-history/index.tsx`, `apartment/[apartmentId]/index.tsx`, `step-five.tsx`, `notifications.tsx`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `carousel.tsx`, `table.tsx`, `card.tsx`, `sheet.tsx`, `tooltip.tsx`, `dropdown-menu.tsx`, `chart.tsx`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `formatPesoDisplay()` connect `formatPesoDisplay` to `apartments/index.ts`, `create/page.tsx`, `useColors`, `createClient`, `applications/index.ts`, `formatDate`, `formatAddress`, `carousel.tsx`, `review-information.tsx`, `supabase/src/index.ts`, `cards/ApartmentCard.tsx`, `ProfitTrendCard.tsx`, `fifth-step.tsx`, `my-rental/page.tsx`, `history/index.tsx`, `tenant/applications/[applicationId]/page.tsx`, `utils/src/index.ts`, `units.tsx`, `[apartmentId]/page.tsx`, `first-process.tsx`, `payment-history/index.tsx`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `googleMapsKey`, `PaymentSummaryCardProps`, `INITIAL_REGION` to the rest of the system?**
...
- **Should `formatPesoDisplay` be split into smaller, more focused modules?**
