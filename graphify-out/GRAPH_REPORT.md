# Graph Report - apt-rental-platform  (2026-08-19)

## Corpus Check
- 730 files · ~912,133 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3544 nodes · 7352 edges · 303 communities (187 shown, 116 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `04755986`
...
## Communities (303 total, 116 thin omitted)
...
Cohesion: 0.07
Nodes (34): FormErrors, Amenities(), FourthStep(), FormErrors, Index(), DEFAULT_COORDS, MAP_STYLE, MapPin() (+26 more)
...
Cohesion: 0.16
Nodes (20): RatingsPage(), ApartmentReview, formatLeaseDuration(), getApartmentReviewsQueryKey(), getErrorMessage(), RatingBarCountData, useApartmentReviews(), UseApartmentReviewsResult (+12 more)
...
### Community 10 - "apartments/index.ts"
Cohesion: 0.05
Nodes (49): ApartmentSummary(), ApartmentSkeleton(), IconButton(), IconButtonProps, IconComponent, ApartmentDescriptionSection(), ApartmentDescriptionSectionProps, ApartmentDetailsSection() (+41 more)
...
### Community 13 - "usePHPostalCode.ts"
Cohesion: 0.10
...
### Community 15 - "StandardHeader.tsx"
Cohesion: 0.07
Nodes (25): RateApartmentSkeleton(), ErrorDialogState, FormErrors, RateApartment(), TenancyLeasePeriod, TenantApplicationDetailsSkeleton(), faqs, SettingItem (+17 more)

### Community 16 - "[apartmentId]/page.tsx"
Cohesion: 0.07
Nodes (26): Amenities(), AmenitiesProps, BackBtn(), ExpandableDescription(), Props, ImageHeader(), ImageHeaderProps, LandlordChatPanel() (+18 more)

### Community 17 - "edit-profile.tsx"
Cohesion: 0.09
Nodes (35): FieldErrors, FormErrors, AuthCompleteProfile(), ProfileForm, requiredFields, CompleteProfile(), ProfileForm, requiredFields (+27 more)

### Community 18 - "maintenance-requests/index.ts"
Cohesion: 0.11
Nodes (25): MaintenanceRequestCard(), MaintenanceRequestCardProps, MaintenanceRequestCardSkeleton(), LOCATION_OPTIONS, MaintenanceRequestFilters, MaintenanceRequestFilterSheet(), Props, STATUS_OPTIONS (+17 more)
...
### Community 25 - "request-maintenance.tsx"
Cohesion: 0.17
Nodes (17): ResolveRequestDialog(), ResolveRequestDialogProps, MaintenanceRequestDetails(), MaintenanceRequestCard(), MaintenanceRequestCardProps, MaintenanceDetails(), MaintenanceDetails, MaintenanceErrors (+9 more)
...
### Community 29 - "rentals.tsx"
Cohesion: 0.09
Nodes (25): VisitRequestCalendar(), VisitRequestCalendarProps, VisitRequestCardSkeleton(), DATE_RANGE_OPTIONS, DateRange, Props, STATUS_OPTIONS, VisitRequestFilters (+17 more)
...
Cohesion: 0.17
Nodes (19): GENERAL_TOGGLES, GeneralToggleKey, NOTIFICATION_TYPE_LABELS, useInAppNotificationBanner(), getNotificationPreferencesQueryKey(), mockFetchNotificationPreferences, mockUpdateNotificationPreferences, mockUseCurrentUser (+11 more)
...
### Community 38 - "useColors"
Cohesion: 0.04
Nodes (71): Index(), Failed(), SelectId(), AnalyticsScreen(), MAX_AMOUNT, monthlyData, stats, EmptyMaintenanceRequestDetail() (+63 more)
...
Cohesion: 0.27
Nodes (6): dbClient, hmacSha256Hex(), isSignatureValid(), ParsedEvent, parseSignatureHeader(), timingSafeEqual()
...
Cohesion: 0.17
Nodes (9): BATHROOM_OPTIONS, BEDROOM_OPTIONS, Filters, INITIAL_FILTERS, LOCATIONS, Props, SORT_OPTIONS, FLOOR_LEVELS (+1 more)

### Community 48 - "supabase/src/index.ts"
Cohesion: 0.09
Nodes (24): AuthButton(), AuthButtonProps, AuthDivider(), AuthDividerProps, RoleTab(), RoleTabProps, OTPVerification(), OTPVerification() (+16 more)
...
### Community 51 - "applications/index.ts"
Cohesion: 0.05
Nodes (47): getStatusStyle(), TenantApplicationDetails(), ApplicationFilters, ApplicationFilterSheet(), LOCATION_OPTIONS, Props, STATUS_OPTIONS, getInitials() (+39 more)
...
### Community 56 - "utils/src/index.ts"
Cohesion: 0.14
Nodes (9): RatingsSectionProps, ChatEmptyState(), ChatEmptyStateProps, SmallRatingCard(), SmallRatingCardProps, AddressInput, DateFormat, NameInput (+1 more)
...
Cohesion: 0.15
Nodes (16): NotificationCardType, NotificationFilter, NotificationList(), NotificationListProps, NotificationScreen(), NotificationScreenProps, useNotificationActions(), getErrorMessage() (+8 more)

### Community 73 - "NotificationToast.tsx"
Cohesion: 0.16
...
### Community 76 - "profilesService.ts"
Cohesion: 0.22
...
### Community 77 - "maintenanceService.ts"
Cohesion: 0.21
...
### Community 78 - "upload-id.test.tsx"
Cohesion: 0.25
...
### Community 81 - "my-rental/types.ts"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (22): ChatHeader(), ChatHeaderProps, DOCUMENT_TYPE_ICONS, SelectDocument(), AIHeaderProps, getLastMessageDisplay(), MessageCard(), MessageCardProps (+14 more)

### Community 84 - "landlordService.ts"
Cohesion: 0.11
Nodes (21): Index(), useLandlordStats(), DB_TO_DISPLAY_STATUS, DbStatus, DISPLAY_TO_DB_STATUS, fetchLandlordStats(), fetchLandlordVisitRequests(), fetchManageApartmentDescription() (+13 more)
...
Cohesion: 0.22
Nodes (11): getCaptureSequence(), getNextCaptureStep(), LiveCapture(), SelfiePrep(), Success(), UploadSelfie(), useVerificationStore, mockBack (+3 more)

### Community 97 - "paymongo/index.ts"
Cohesion: 0.15
Nodes (23): badRequest(), CardPaymentPayload, CheckoutSessionPayload, CheckoutSessionStatus, corsHeaders, createCardPayment(), createCheckoutSession(), createRealCardPayment() (+15 more)

### Community 99 - "useVisitRequest.ts"
Cohesion: 0.48
...
Cohesion: 0.15
Nodes (14): RatingBarCount(), RatingBarCountProps, ReviewsPage(), SORT_OPTIONS, SearchHeader(), SearchHeaderProps, DropdownButton(), DropdownButtonProps (+6 more)
...
Cohesion: 0.22
Nodes (10): ThirdStep(), ApartmentDescriptionCard(), ApartmentDescriptionCardProps, PaymentFooter(), PaymentFooterProps, PaymentSummaryCard(), PaymentSummaryCardProps, extractRawNumber() (+2 more)
...
### Community 133 - "notificationDeepLink.ts"
Cohesion: 0.23
...
### Community 151 - "chatService.pagination.test.ts"
Cohesion: 0.16
...
### Community 167 - "PaymentMethodCard.tsx"
Cohesion: 0.47
...
### Community 181 - "ProfitByPropertyCard.tsx"
Cohesion: 0.27
Nodes (7): chartLabel(), ProfitByPropertyCard(), ProfitByPropertyCardProps, EmptyState(), EmptyStateProps, PropertyRevenue, MONTHS

### Community 183 - "edit-main.tsx"
Cohesion: 0.09
Nodes (29): TODO: Persist the uploaded document to Supabase Storage and store its, Upload(), FifthStep(), ApartmentInformation, DisplayImage, EditMain(), validateForm(), ApartmentMainFields (+21 more)

### Community 188 - "useLandlordActionBadges"
Cohesion: 0.24
...
### Community 189 - "sheet.tsx"
Cohesion: 0.18
Nodes (7): Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle()

### Community 192 - "useCurrentUser"
Cohesion: 0.47
Nodes (6): useCurrentUser(), useCurrentUserId(), getCurrentUser(), getUserProfileByColumn(), getUserProfileById(), UserProfile

### Community 197 - "description/index.tsx"
Cohesion: 0.16
Nodes (11): PerksSection(), PerksSectionProps, EditPerks(), CurrentApartmentDetails(), formatDateToMonthYear(), MONTHS, Divider(), DividerProps (+3 more)
...
Cohesion: 0.15
Nodes (18): validateCashPayment(), formatLeaseDate(), INITIAL_CARD, PaymentCheckout(), resolvePaymentPeriod(), toIsoDate(), createCashPayment(), paidAmountForPeriod() (+10 more)

### Community 258 - "PayMongo Go-Live Plan (Mobile-first)"
Cohesion: 0.15
Nodes (12): Current state summary, Decisions (locked), Out of scope (documented follow-ups), Owner action items (only you can do these), Part 1 — DB schema (foundation) ✅ DONE (2026-08-19), Part 2 — Edge functions: real PayMongo ✅ DONE (2026-08-19), Part 3 — Frontend data wiring (mobile) ✅ DONE (2026-08-19), Part 4 — Saved payment methods: **deferred** (+4 more)

### Community 259 - "MiniCalendar.tsx"
Cohesion: 0.36
Nodes (6): DashboardCard(), DashboardCardProps, formatShortDate(), MiniCalendar(), MiniCalendarProps, toCalendarDate()

### Community 260 - "constants/src/index.ts"
Cohesion: 0.36
Nodes (5): COLORS, FONT_FAMILIES, THEME_FONTS, THEME_FONTS_WEB, YEARS
...
### Community 263 - "tenancy/index.ts"
Cohesion: 0.39
...
### Community 268 - "use-tenancy.ts"
Cohesion: 0.40
Nodes (4): CurrentTenancy, TenancyApartment, TenancyLandlord, TenancyPayment

### Community 270 - "formatDate"
Cohesion: 0.13
Nodes (23): EmptyRequestData(), VisitRequestCard(), VisitRequestCardProps, VisitRequestDetails(), ApplicationApartment(), Props, VisitRequest, VisitRequestCard() (+15 more)
...
### Community 294 - "useNotificationRealtime.ts"
Cohesion: 0.47
Nodes (5): attach(), ChannelEntry, detach(), handleEvent(), registry
...
### Community 297 - "selfie-prep.test.tsx"
Cohesion: 0.33
Nodes (5): BACK_CAPTURE, FRONT_CAPTURE, mockBack, mockPush, mockReplace

### Community 304 - "payment-history.tsx"
Cohesion: 0.26
Nodes (15): PaymentHistoryCard(), PaymentHistoryCardProps, FlatPayment, PaymentHistoryScreen(), toFlatPayment(), ReceiptCard(), toHistoryItem(), PaymentReceipt() (+7 more)

### Community 306 - "ApartmentImagesModal.tsx"
Cohesion: 0.50
Nodes (4): ApartmentImage, ApartmentImagesModal(), generateFilename(), Props

## Knowledge Gaps
- **1292 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `type`, `url`, `type` (+1287 more)
...
- **Why does `useColors()` connect `useColors` to `units.tsx`, `second-step.tsx`, `ratings/index.ts`, `step-five.tsx`, `apartments/index.ts`, `formatDate`, `StandardHeader.tsx`, `edit-profile.tsx`, `maintenance-requests/index.ts`, `PropertyCard.tsx`, `request-maintenance.tsx`, `rentals.tsx`, `RescheduleSheet.tsx`, `notificationService.ts`, `ChatBubble.tsx`, `ai-search.tsx`, `supabase/src/index.ts`, `review-information.tsx`, `live-capture.tsx`, `payment-history.tsx`, `applications/index.ts`, `ProfitByPropertyCard.tsx`, `ProfitTrendCard.tsx`, `edit-main.tsx`, `utils/src/index.ts`, `document-id/index.tsx`, `description/index.tsx`, `useSearchLogic.tsx`, `NotificationToast.tsx`, `app/_layout.tsx`, `maintenanceService.ts`, `expo-router`, `landlordService.ts`, `useFavorites`, `history/index.tsx`, `PaymentMethodSelector.tsx`, `TabBar.tsx`, `upload-id.tsx`, `[conversationId].tsx`, `useVerificationStore`, `ReceiptCard.tsx`, `reviews/index.tsx`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `expo-router` connect `expo-router` to `units.tsx`, `second-step.tsx`, `payment/index.tsx`, `expo`, `notificationDeepLink.ts`, `step-five.tsx`, `apartments/index.ts`, `formatDate`, `StandardHeader.tsx`, `edit-profile.tsx`, `maintenance-requests/index.ts`, `request-maintenance.tsx`, `rentals.tsx`, `notificationService.ts`, `useColors`, `supabase/src/index.ts`, `review-information.tsx`, `live-capture.tsx`, `payment-history.tsx`, `applications/index.ts`, `edit-main.tsx`, `document-id/index.tsx`, `card-form.tsx`, `useFrameQualityCheck.ts`, `description/index.tsx`, `useSearchLogic.tsx`, `NotificationScreen.tsx`, `app/_layout.tsx`, `maintenanceService.ts`, `onboarding.tsx`, `useFavorites`, `history/index.tsx`, `upload-id.tsx`, `[conversationId].tsx`, `playground.tsx`, `reviews/index.tsx`?**
