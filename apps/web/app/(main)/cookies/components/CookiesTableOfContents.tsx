...
import { TOC } from "../data/cookies-sections";
import { fadeUp } from "../data/animations";

type CookiesTableOfContentsProps = {
  activeId: string;
  onNavigate: (id: string) => void;
};

export default function CookiesTableOfContents({ activeId, onNavigate }: CookiesTableOfContentsProps) {
  return (
    <motion.aside
      variants={fadeUp}
      initial="hidden"
