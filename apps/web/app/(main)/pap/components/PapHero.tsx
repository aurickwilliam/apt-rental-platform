      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Breadcrumbs className="text-default-500 text-sm">
            ...
            <Breadcrumbs.Item>Privacy Policy</Breadcrumbs.Item>
          </Breadcrumbs>
        </motion.div>
        ...
        >
          This Privacy Policy explains how APT collects, uses, stores,
