// apps/web/app/(main)/pap/components/PapSection.tsx
import { Alert } from "@heroui/react";
import { motion } from "framer-motion";
import type { Section } from "../data/pap-sections";
import { fadeUp } from "../data/animations";

type PapSectionProps = {
  section: Section;
  isLast: boolean;
  sectionRef: (el: HTMLDivElement | null) => void;
};

export default function PapSection({ section, isLast, sectionRef }: PapSectionProps) {
