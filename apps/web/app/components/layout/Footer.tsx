      ...
      <Accordion showDivider={false} className="md:hidden">
        ...
        >
          <div className="flex flex-col gap-2">
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Company</Link>
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Community</Link>
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Careers</Link>
        ...
        >
          <div className="flex flex-col gap-2">
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Help Center</Link>
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Contact Us</Link>
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Safety & Security</Link>
        ...
        >
          <div className="flex flex-col gap-2">
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Search Rentals</Link>
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">List Your Property</Link>
            <Link href="#" className="text-base font-medium text-white/80 hover:text-white">Online Application</Link>
