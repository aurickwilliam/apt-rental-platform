  ...
  return (
    ...
    >
      <View className="flex-row gap-1 items-center">
        ...
        />
        <Text className="text-foreground font-nunitoSemiBold flex-1">
          {propertyName}
        </Text>
        {isOverdue && (
          <View className="flex-row items-center gap-1">
            <IconAlertTriangle size={14} color={colors.danger} />
            <Text className="text-danger font-nunitoSemiBold text-xs">
              Overdue
            </Text>
          </View>
        )}
      ...
      <Text className="text-muted font-nunitoSemiBold mt-1">
        {tenantName}
      </Text>
      <View className="flex-row justify-between items-center mt-2">
        ...
        <Text className={`text-base font-nunitoSemiBold ${isOverdue ? "text-danger" : "text-accent"}`}>
          {formattedAmount}
        </Text>
      </View>
    </TouchableOpacity>
